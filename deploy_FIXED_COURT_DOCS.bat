...
copy \"..\probate_cases\pdfs\published\*.pdf\" \"pdfs\published\\"
if errorlevel 1 (
    echo ❌ Failed to copy published PDFs
    echo Trying alternative path...
    copy \"..\..\probate_cases\pdfs\published\*.pdf\" \"pdfs\published\\"
    if errorlevel 1 (
        echo ❌ Still failed - checking what files exist...
        dir \"..\probate_cases\pdfs\published\*.pdf\"
        pause
    ) else (
        echo ✅ Published PDFs copied successfully (alternative path)
    )
) else (
...
copy \"..\probate_cases\pdfs\unpublished\*.pdf\" \"pdfs\unpublished\\"
if errorlevel 1 (
    ...
    if errorlevel 1 (
        echo ❌ Still failed - checking what files exist...
        dir \"..\probate_cases\pdfs\unpublished\*.pdf\"
        pause
    ) else (
        echo ✅ Unpublished PDFs copied successfully (alternative path)
    )
) else (
...
copy \"..\probate_cases\pdfs\published_text\2025-07_(Published)\*.txt\" \"texts\\"
copy \"..\probate_cases\pdfs\published_text\2025-07_Case_Briefs_(Published)\*.txt\" \"texts\\"
copy \"..\probate_cases\pdfs\unpublished_text\2025-07_(Unpublished)\*.txt\" \"texts\\"
copy \"..\probate_cases\pdfs\unpublished_text\2025-07_Case_Briefs_(Unpublished)\*.txt\" \"texts\\"
echo ✅ Text file copying attempted
